<?php
    ...
    $valori_replace = array($footer, $numero_corsi, $listaCard_offerta, $nome_categoria, $descrizione_categoria, $immagine_categoria, $alt_categoria, genera_header_param("categoria",$id_categoria));
