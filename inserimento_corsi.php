...
<?php 
    ...
    echo genera_header("inserimento corsi");
    $categorie;
...
?>
    <form class="adminform" action="inserimento_corsi.php?action=insert" method="post" id="inserisci">
        <fieldset>
...
?>
        ...
        <fieldset>
            <legend>Caratterisstice</legend>
                ...
                <input type="text" id="durata" name="durata" placeholder="30-45" required>
